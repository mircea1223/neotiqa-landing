...
export const metadata: Metadata = {
  ...
  description:
    "Terms and conditions for ExtensionAI AI-powered home extension visualisation platform",
};
          ...
          <div className="prose prose-lg max-w-none text-foreground">
            <section className="mb-8">
              ...
              <p className="mb-4 text-foreground/80">
                By accessing and using ExtensionAI ("the Service"), you accept
            ...
            <section className="mb-8">
              ...
              <p className="mb-4 text-foreground/80">
                ExtensionAI provides AI-powered home extension visualisation
                services that allow users to upload property photos and generate
                realistic visualisations of potential extensions,
                conservatories, orangeries, and verandas.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 mb-4 text-foreground/80">
                <li>
                  Upload images that you do not own or have permission to use
                </li>
                <li>
                  Generate visualisations for illegal or unauthorised purposes
                </li>
                <li>
                ...
                <li>
                  Transmit any material that infringes upon intellectual
                  property rights
                </li>
                <li>
            ...
            <section className="mb-8">
              ...
              <p className="mb-4 text-foreground/80">
                ...
                functionality are owned by NEOTIQA and are protected by
            ...
            <section className="mb-8">
              ...
              <p className="mb-4 text-foreground/80">
                You retain ownership of images you upload. By uploading content,
                you grant us a limited license to process and generate
                visualisations. We do not claim ownership of your uploaded
                images.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="mb-4 text-foreground/80">
                In no event shall NEOTIQA be liable for any indirect,
